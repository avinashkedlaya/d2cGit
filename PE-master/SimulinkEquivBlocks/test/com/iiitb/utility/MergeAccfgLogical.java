...
public class MergeAccfgLogical {
	@BeforeClass
	...
	public static Accfg mergeTest(ArrayList<Block> blockList) {
		...
		merged = new Accfg();
		 ...
		 Iterator<String> iterKey =  FetchInputFromLineLogicalOperator.adjacencyList.keySet().iterator();
		 ...
		 while(iterKey.hasNext())
		 {
			 ...
			 Iterator<DestNode> tempIter = FetchInputFromLineLogicalOperator.adjacencyList.get(key).iterator();
		   ...
		   * As per our model it should contain - Constant , Constant1,LogicalOperator
		   * 
		  ...
		  Block[] test = {new Constant("Constant"),new Constant("Constant1"),new LogicalOperator("Logical"+"\n"+"Operator")};
		   ...
		   *  Constant1=4
		   *  Constant=1
		   *  LogicalOperaor=(Constant OR Constant1)
		   * 
		...
		while(test7Iter.hasNext())
		{
			...
			assertTrue(tempFp, tempFp.equalsIgnoreCase("Logical"+"\n"+"Operator=(Constant OR Constant1)") || tempFp.equalsIgnoreCase("Constant1=4") || tempFp.equalsIgnoreCase("Constant=1"));
	...
	public static Accfg findInputOutputVariableTest(Accfg accfg,
		 ...
		 *  LogicalOperator 	  ==> input - Constant & Constant1 , output - LogicalOperator 
		 *  
